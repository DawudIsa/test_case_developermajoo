...
<head>
	...
	<title>Majoo Teknologi Indonesia - Product</title>
					...
					<div class="panel-body">
						...
						<table class="table table-bordered table-striped">
                            <tr>
                                <th>No. </th>
                                <th>Nama Produk </th>
                                <th width="120px">Harga Produk </th>
							...
							<tr>
                                ...
                                <td>
                                    <a href="/admin/product/productedit/{{ $p->product_id }}" class="btn btn-sm btn-info"><em class="fa fa-edit"></em> Edit </a>
                                    <a href="/admin/product/productdelete/{{ $p->product_id }}" class="btn btn-sm btn-danger"><em class="fa fa-trash"></em> Hapus </a>
                                </td>
                            </tr>
							@endforeach
                        </table>
