        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="left-content">
              ...
              <h3 style=>Rp. {{ number_format($p->product_price,0 , ',', '.') }}</h3>
              <a href="/productpay/{{ $p->product_id }}" class="filled-button">Beli</a>
            </div>
          </div>
          <div class="col-md-6">
            <div class="right-image">
              <img src="{{ asset('assets/images/'.$p->product_image) }}" alt="">
            </div>
          </div>
          @endforeach
        </div>
